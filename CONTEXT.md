...
| **Token** | Kode satu kali yang dihasilkan Pengawas, digunakan Peserta untuk memasuki Ujian. |
...
| **Menu Pengawas** | Menu tersembunyi yang hanya dapat diakses oleh Pengawas untuk membuat Token. _Avoid_: hidden menu. |
...
| **Gesture** | Urutan ketukan (tap logo 3×, Petunjuk 1×) untuk membuka Menu Pengawas. Diimplementasikan sebagai pure state machine. |
